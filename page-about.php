...
<section data-scroll-container class="border-y-2  py-12 lg:py-24 overflow-hidden">
    ...
    <?php if (have_rows("repeater")) :
        ...
        while (have_rows("repeater")) : the_row(); ?>
            <div class=" h-[80vh] md:h-[60vh] relative lg:mb-40 flex flex-col lg:flex-row lg:odd:flex-row-reverse gap-10 px-8 md:px-16 lg:px-24 odd:text-right  " data-scroll data-scroll-speed="3">
                <div data-js="left" class="sticky bottom-0  flex items-center   w-full h-[200px] "><?= get_sub_field('about_me_text') ?></div>
